const selectedWorks = [
    {
      ...
      "landscapeImage": "https://res.cloudinary.com/dyxxn831a/image/upload/v1691764224/portfolio%20images/fashion-photo-seductive-model-with-perfect-body-posing-tropical-beach-sunset-colots_ol2r9j.jpg",
      ...
      "backgroundDescription": "As a group project, I collaborated with two other women in my bootcamp to make Zaza come to life, a full-stack lingerie and fragrance store. Since the bootcamp was 90% male, we wanted to make a site geared towards primarily women and female sensuality. The goal was to make the site look real, professional, and authentic and to include stripe for card payments. We each had our own responsibilities in the project, and it was through good communication, frequent updates and meetings, and togetherness that we were able to complete the project by the deadline. In the future, we seek to include men's wear for more inclusivity as well as customer review sections per product displayed."
    },
    {
      "id": 2,
      "title": "Baud Labs",
      ...
      "github": 'baud-labs/company-website',
      "link": 'https://www.baudlabs.com.ng/',
      ...
      "opening": 'Organizations trust us and our world-class intelligent software solutions to make proficient enhancements.',
      ...
      "backgroundDescription": "This application was designed and developed by myself as part of my role as a frontend intern at Baud Technologies. Being a bit of a perfectionist, I wanted the website to look good and professional and to match the overall feel of what my employer was going for. His desire was for his company website to be a single-page website with a scientific, AI feel. I incorporated the requirements that he set, but I also wanted to elevate it using GSAP, adding a bit of my own spin visually. I was thinking about Star Trek and UFOs while designing the site, and as a result, my employer was extremely satisfied with the end product."
    },
    {
      "id": 3,
      "title": "Oasis",
      ...
      "technologies": ['Handlebars.js', 'Javascript', 'Node.js', 'Express.js', 'MySQL', 'Figma'],
      "github": 'robobrownie13/animal-blog-group-4-p2',
      "link": 'https://salty-badlands-43491.herokuapp.com/',
      ...
      "opening": 'Immerse yourself in a vibrant community dedicated to protecting endangered animals. ',
      "projectDescription": "This website is more than just a platform-it’s a hub where passionate individuals unite to discuss the state of vulnerable, endangered creatures.",
      "backgroundDescription": "Oasis is an interactive, sociable, and informative blog site regarding endangered animals where users alike can discuss many different topics by creating posts, share information from external sites through comments, and create accounts of their own in order to gain extended knowledge, current data, and support from many users all across the globe. My team didn't just want to make things functional and make sure that things were working well in the frontend and the backend, but we also sought to solve a problem with our project, which is where the power of coding comes in. In the future, our objective is to allow users the opportunity to follow other users and favorite posts to keep a steady record of posts and users that inspire."
    },
    {
      "id": 4,
      "title": "Lofi Train",
