    ...
    <section>
      <div className="works-render-section">
        {selectedWorks.map((works) => {
          return (
            <motion.div
              initial={{ opacity: 0, y: 60, borderRadius: "0% 0% 50% 50%" }}
              whileInView={{
                opacity: 1,
                y: 0,
                borderRadius: "0%",
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  backgroundImage: `url(${works.landscapeImage})`,
                  // transform: imageHover ? "scale(.95)" : "",
                  // borderRadius: imageHover ? "50%" : "",
                }}
              ></motion.div>
            </motion.div>
          );
